 ...
 */
public class StoreDatabaseSale extends SQLiteOpenHelper implements BaseColumns {
    ...
    public static String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS sale";
    public static String SQL_CLEAN_ENTRIES = "DELETE from sale";

    public StoreDatabaseSale(Context context) {
